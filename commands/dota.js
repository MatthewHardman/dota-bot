...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const message = await interaction.reply({
      content: ` Hello <@&${role.id}>, ${interaction.user.username} would like to play with a stack size of ${stackSize} and is willing to wait ${timeOutInMin} minutes! Please react if you'd like to be pinged when a stack forms. ` + interaction.user.username + `, I have reacted for you.`,
      fetchReply: true,
    });
